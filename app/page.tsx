...
export default function Home() {
  ...
  useEffect(()=>{
    setActiveJobsData(meetings.filter(meeting => meeting.job_id && (meeting?.job_id?.jobRequest_isActive && !meeting?.job_id?.jobRequest_isClosed)))
    setInActiveJobsData(meetings.filter(meeting => meeting.job_id && (!meeting.job_id.jobRequest_isActive || meeting.job_id.jobRequest_isClosed)))
  },[meetings]);
