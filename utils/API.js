...
const makeRequest = async (endpoint, data, method = "post",hasParam = false) => {
  try {
...
export const USER_ACCOUNT_MANAGEMENT_ACCOUNT_API = () =>
  ...
  export const GET_MEETINGS_DETAILS_API = ({from_date,to_date}) =>
  makeRequest(API_ENDPOINTS.USER_MEETINGS_INFO, {
    from_date: from_date,
    to_date: to_date,
  },"get",true);
